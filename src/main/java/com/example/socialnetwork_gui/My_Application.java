...
public class My_Application {
    ...
    public My_Application(UserRepository userRepository, FriendshipRepository friendshipRepository, UserMapper userMapper, CommandParser commandParser, ExceptionHandler exceptionHandler, FriendshipMapper friendshipMapper, MessageRepository messageRepository,MessageMapper messageMapper) {
    ...
    public void run() {
        ...
        UserFacade userFacade = new UserFacadeImpl(
                new UserServiceImpl(userRepository, friendshipRepository, userValidator, friendshipValidator,messageRepository),
                userMapper,
                friendshipMapper,
                messageMapper);

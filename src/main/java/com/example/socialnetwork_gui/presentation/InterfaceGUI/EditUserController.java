...
public class EditUserController {
    ...
    public void handleAdd(ActionEvent actionEvent){
        ...
        try {
            ...
            if (u1==null)
                dialogStage.close();
            UserAlert.showMessage(null, Alert.AlertType.INFORMATION,"Save user","The user has been saved successfully!");
    ...
    private void handleUpdate(ActionEvent actionEvent)
    {
        ...
        try {
            ...
            if (u==null)
                UserAlert.showMessage(null, Alert.AlertType.INFORMATION,"Update user","The user has been update successfully!");
        } catch (EntityNotFoundException e) {
            UserAlert.showErrorMessage(null,e.getMessage());
        }
        clearFields_userdto();
